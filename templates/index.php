<section class="promo">
  ...
  <ul class="promo__list">
    <?php foreach ($categories as $iconCategorie => $categorie):  ?>
      <li class="promo__item <?=$iconCategorie; ?>">
          <a class="promo__link" href="all-lots.html"><?php echo htmlentities($categorie); ?></a>
      </li>
      <?php endforeach; ?>
  </ul>
</section>
    ...
    <?php foreach ($goods as $good): ?>
      <li class="lots__item lot">
          <div class="lot__image">
              <img src=<?=$good['url']; ?> width="350" height="260" alt=<?php echo htmlentities($good['description']); ?>>
          </div>
          <div class="lot__info">
